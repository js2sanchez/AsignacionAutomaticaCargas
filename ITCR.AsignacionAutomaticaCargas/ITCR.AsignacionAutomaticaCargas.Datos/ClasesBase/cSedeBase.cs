...
namespace ITCR.AsignacionAutomaticaCargas.Base
{
	...
	public class cSedeBase : cBDInteraccionBase
	{
		#region Declaraciones de miembros de la clase
			...
			private SqlString		_nombreSede, _codigoSede;
		#endregion
		...
		public override bool Insertar()
		{
			...
			try
			{
				cmdAEjecutar.Parameters.Add(new SqlParameter("@snombreSede", SqlDbType.VarChar, 50, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, _nombreSede));
				cmdAEjecutar.Parameters.Add(new SqlParameter("@scodigoSede", SqlDbType.VarChar, 10, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, _codigoSede));
		...
		public override DataTable SeleccionarUno()
		{
			...
			try
			{
				...
				if(toReturn.Rows.Count > 0)
				{
					...
					_nombreSede = (string)toReturn.Rows[0]["nombreSede"];
					_codigoSede = (string)toReturn.Rows[0]["codigoSede"];
		...
		public SqlString NombreSede
		{
			...
			set
			{
				SqlString nombreSedeTmp = (SqlString)value;
				if(nombreSedeTmp.IsNull)
				{
					throw new ArgumentOutOfRangeException("NombreSede", "NombreSede can't be NULL");
				}
				_nombreSede = value;
			}
		}
		...
		public SqlString CodigoSede
		{
			...
			set
			{
				SqlString codigoSedeTmp = (SqlString)value;
				if(codigoSedeTmp.IsNull)
				{
					throw new ArgumentOutOfRangeException("CodigoSede", "CodigoSede can't be NULL");
				}
				_codigoSede = value;
			}
		}
