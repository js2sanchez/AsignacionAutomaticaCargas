<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Consultar_PerfilProfesor.aspx.cs" Inherits="ITCR.AsignacionAutomaticaCargas.Interfaz.View.Profesor.Consultar_Profesor" %>
        ...
        <section class="form-width">
            ...
            <div class="row row-centered">
                <div class="col-centered col-min">
                    <asp:Button ID="btnActualizar" runat="server" class="btn btn-default" Text="Actualizar" />
                </div>
                <div class="col-centered">

                </div>
                <div class="col-centered col-min">
                    <asp:Button ID="btnEliminar" runat="server" class="btn btn-default" Text="Eliminar" OnClick="btnEliminar_Click" />
                </div>
            </div>
        </section>
    </div>
