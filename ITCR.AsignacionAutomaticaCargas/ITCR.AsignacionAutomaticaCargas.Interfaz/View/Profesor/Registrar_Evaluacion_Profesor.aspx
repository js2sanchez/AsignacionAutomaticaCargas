<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Registrar_Evaluacion_Profesor.aspx.cs" Inherits="ITCR.AsignacionAutomaticaCargas.Interfaz.View.Profesor.Registrar_Evaluacion_Profesor" %>
                 ...
                 <div class="container">
		            <div class="row row-centered">
		              <div class="col-xs-6 col-centered col-min">
                          <asp:TextBox ID="txtCedulaIdentidad" runat="server" class="form-control" maxlength="50" placeholder="Cédula de identidad" ToolTip="Ejemplo: 109768342"></asp:TextBox>
                          <asp:RequiredFieldValidator ID="rfvCedula" runat="server" ControlToValidate="txtCedulaIdentidad"
                              class="validation" ValidationGroup="vgRegistrarEvaluacionProfeso">* Dato requerido</asp:RequiredFieldValidator>
                         ...
                         <div class="col-xs-6 col-centered col-min">
                            ...
                            <asp:CompareValidator ID="cvPeriodo" runat="server" ValueToCompare="0"
                             ...
                             <div class="row row-centered">
		              <div class="col-xs-6 col-centered col-min">
                          <asp:TextBox ID="txtCalificacion" runat="server" class="form-control" maxlength="50" placeholder="Calificación período" ToolTip="Ejemplo: 7.5"></asp:TextBox>
            ...
            bootbox.dialog({
                ...
                buttons: {
                    success: {
                        ...
                        callback: function () {
                            location.href = "/View/Profesor/Consultar_Evaluacion_Profesor.aspx";
                        }
                    }
                }
            });
