                    ...
                    <div class="row row-centered">
                        <div class="col-xs-6 col-centered col-min">
                            <asp:DropDownList ID="drpGradoAcademico" runat="server" class="form-control">
                                <asp:ListItem Text="Grado Académico" Value="0" Selected="True"/>
                            </asp:DropDownList>
                            <asp:CompareValidator ID="cvGradoAcademico" runat="server" ValueToCompare="0"
                                ControlToValidate="drpGradoAcademico"
                                class="validation" Operator="NotEqual" ValidationGroup="vgAgregarCurso">* Seleccione una opción válida</asp:CompareValidator>
                        </div>
                        <div class="col-xs-6 col-centered col-min">
                        </div>
                    </div>
