<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OpenAuthProviders.ascx.cs" Inherits="ITCR.AsignacionAutomaticaCargas.Interfaz.Account.OpenAuthProviders" %>
